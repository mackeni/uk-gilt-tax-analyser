...
export class GiltDataFetcher {
  ...
  async getFallbackData() {
    try {
      ...
      const staticGiltData = [
        ...
        { name: 'Treasury 2% 2025', couponRate: 2.0, maturityDate: '2025-09-07', cleanPrice: 99.69, currentYield: 4.08 },
        { name: 'Treasury 3.5% 2025', couponRate: 3.5, maturityDate: '2025-10-22', cleanPrice: 99.78, currentYield: 4.22 },
        { name: 'Treasury 0.125% 2026', couponRate: 0.125, maturityDate: '2026-01-30', cleanPrice: 98.20, currentYield: 3.28 },
        ...
        { name: 'Treasury 6% 2028', couponRate: 6.0, maturityDate: '2028-12-07', cleanPrice: 106.62, currentYield: 3.84 },
        ...
        { name: 'Treasury 4% 2031', couponRate: 4.0, maturityDate: '2031-10-22', cleanPrice: 98.05, currentYield: 4.35 },
        { name: 'Treasury 1% 2032', couponRate: 1.0, maturityDate: '2032-01-31', cleanPrice: 81.08, currentYield: 4.32 },
        ...
        { name: 'Treasury 4.25% 2034', couponRate: 4.25, maturityDate: '2034-07-31', cleanPrice: 96.75, currentYield: 4.70 },
  ...
  async fetchFromDividendData() {
    try {
      ...
      // This would be the live API call in production
      // For now, return the comprehensive 37-gilt dataset
      const liveGiltData = [
