...
// .wrangler/tmp/bundle-EZfgIp/checked-fetch.js
...
// .wrangler/tmp/bundle-EZfgIp/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-EZfgIp/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
                    ...
                    if (gilt.couponSchedule && gilt.couponSchedule.length > 0) {
                        ...
                        gilt.couponSchedule.forEach(payment => {
                            ...
                            scheduleHTML += \`
                                <tr>
                                    ...
                                    <td style="border: 1px solid #ddd; padding: 8px; text-align: right;">\xA3\${roundedTaxAmount.toFixed(2)}</td>
                                    <td style="border: 1px solid #ddd; padding: 8px; text-align: right;"><strong>\xA3\${roundedAfterTaxAmount.toFixed(2)}</strong></td>
                                </tr>
                            \`;
                        });
                        ...
                        scheduleHTML += \`
                            <tr style="background: #e8f5e8; font-weight: bold; border-top: 1px solid #6c757d;">
                                ...
                                <td style="border: 1px solid #6c757d; padding: 8px; text-align: right;"><strong>\xA3\${totalGrossCoupons.toFixed(2)}</strong></td>
                                <td style="border: 1px solid #6c757d; padding: 8px; text-align: right;"><strong>\xA3\${totalCouponTax.toFixed(2)}</strong></td>
                                <td style="border: 1px solid #6c757d; padding: 8px; text-align: right;"><strong>\xA3\${totalNetCoupons.toFixed(2)}</strong></td>
                            </tr>
                        \`;
                            ...
                            <div class="calculation-step" style="background: #f8f9fa; border: 2px solid #007bff; border-radius: 8px; padding: 15px;">
                                ...
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-top: 10px;">
                                    <div>
                                        ...
                                        <p style="margin: 3px 0;"><strong>Total Coupon Income:</strong> \xA3\${totalGrossCoupons.toFixed(2)}</p>
                                        <p style="margin: 3px 0;"><strong>Income Tax:</strong> \xA3\${totalCouponTax.toFixed(2)}</p>
                                        \${monthlyChargeSchedule.length > 0 ? '<p style="margin: 3px 0;"><strong>Account Charges:</strong> \xA3' + totalAccountCharges.toFixed(2) + '</p>' : ''}
                                        <p style="margin: 3px 0;"><strong>Principal Repayment:</strong> \xA3\${principalAmount.toFixed(2)} (tax-free)</p>
                                    </div>
                                    <div>
                            ...
                            scheduleHTML += \`
                                    ...
                                    <div style="background: #f8f9fa; padding: 10px; border-radius: 5px; margin-top: 10px;">
                                        ...
                                        <ul style="margin: 5px 0; padding-left: 20px;">
                                            ...
                                            <li>Maximum per month: \xA3\${currentSettings.accountChargeMax.toFixed(2)}</li>
                                            <li>Gilt price converges linearly from \xA3\${gilt.cleanPrice.toFixed(2)} to \xA3100.00 at maturity</li>
                                            <li>Total account charges over life: \xA3\${monthlyChargeSchedule.reduce((sum, charge) => sum + charge.charge, 0).toFixed(2)}</li>
                                        </ul>
                                    </div>
                                </div>
                            \`;
                                        ...
                                        <div style="font-family: monospace; font-size: 10px; line-height: 1.3;">
                                            ...
                                            \${(() => {
                                                ...
                                                return currentSettings.accountChargeEnabled ? 
                                                    '<p style="margin: 1px 0; color: #666; font-size: 9px;">Debug: Manual charges \xA3' + totalMonthlyCharges.toFixed(6) + ' vs Stored charges \xA3' + storedCharges.toFixed(6) + '</p>' : '';
                                            })()}
