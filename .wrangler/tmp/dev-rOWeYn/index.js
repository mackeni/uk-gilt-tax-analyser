...
// .wrangler/tmp/bundle-g9enkB/checked-fetch.js
...
// .wrangler/tmp/bundle-g9enkB/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-g9enkB/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
  ...
  async getFallbackData() {
    try {
      ...
      const staticGiltData = [
        // Short Term (0-5 years) - Updated for July 22, 2025 market conditions
        { name: "Treasury 2% 2025", couponRate: 2, maturityDate: "2025-09-07", cleanPrice: 99.69, currentYield: 4.08 },
        { name: "Treasury 3.5% 2025", couponRate: 3.5, maturityDate: "2025-10-22", cleanPrice: 99.78, currentYield: 4.22 },
        { name: "Treasury 0.125% 2026", couponRate: 0.125, maturityDate: "2026-01-30", cleanPrice: 98.2, currentYield: 3.28 },
        { name: "Treasury 0.375% 2026", couponRate: 0.375, maturityDate: "2026-10-22", cleanPrice: 95.85, currentYield: 3.69 },
        { name: "Treasury 1.5% 2026", couponRate: 1.5, maturityDate: "2026-07-22", cleanPrice: 97.58, currentYield: 3.85 },
        { name: "Treasury 4.125% 2027", couponRate: 4.125, maturityDate: "2027-01-29", cleanPrice: 100.15, currentYield: 3.97 },
        { name: "Treasury 3.75% 2027", couponRate: 3.75, maturityDate: "2027-03-07", cleanPrice: 99.58, currentYield: 3.95 },
        { name: "Treasury 1.25% 2027", couponRate: 1.25, maturityDate: "2027-07-22", cleanPrice: 94.92, currentYield: 3.82 },
        { name: "Treasury 4.25% 2027", couponRate: 4.25, maturityDate: "2027-12-07", cleanPrice: 100.98, currentYield: 3.78 },
        { name: "Treasury 0.125% 2028", couponRate: 0.125, maturityDate: "2028-01-31", cleanPrice: 91.18, currentYield: 3.75 },
        { name: "Treasury 4.375% 2028", couponRate: 4.375, maturityDate: "2028-03-07", cleanPrice: 100.85, currentYield: 3.99 },
        { name: "Treasury 4.5% 2028", couponRate: 4.5, maturityDate: "2028-06-07", cleanPrice: 101.35, currentYield: 3.96 },
        { name: "Treasury 1.625% 2028", couponRate: 1.625, maturityDate: "2028-10-22", cleanPrice: 93.18, currentYield: 3.83 },
        { name: "Treasury 6% 2028", couponRate: 6, maturityDate: "2028-12-07", cleanPrice: 106.62, currentYield: 3.84 },
        { name: "Treasury 0.5% 2029", couponRate: 0.5, maturityDate: "2029-01-31", cleanPrice: 88.65, currentYield: 3.92 },
        { name: "Treasury 4.125% 2029", couponRate: 4.125, maturityDate: "2029-07-22", cleanPrice: 100.15, currentYield: 4.08 },
        { name: "Treasury 0.875% 2029", couponRate: 0.875, maturityDate: "2029-10-22", cleanPrice: 87.95, currentYield: 3.94 },
        { name: "Treasury 4.375% 2030", couponRate: 4.375, maturityDate: "2030-03-07", cleanPrice: 100.85, currentYield: 4.15 },
        { name: "Treasury 0.375% 2030", couponRate: 0.375, maturityDate: "2030-10-22", cleanPrice: 82.58, currentYield: 4.05 },
        { name: "Treasury 4.75% 2030", couponRate: 4.75, maturityDate: "2030-12-07", cleanPrice: 103.05, currentYield: 4.09 },
        // Medium Term (5-15 years) - Updated for July 22, 2025 market conditions  
        { name: "Treasury 0.25% 2031", couponRate: 0.25, maturityDate: "2031-07-31", cleanPrice: 79.15, currentYield: 4.15 },
        { name: "Treasury 4% 2031", couponRate: 4, maturityDate: "2031-10-22", cleanPrice: 98.05, currentYield: 4.35 },
        { name: "Treasury 1% 2032", couponRate: 1, maturityDate: "2032-01-31", cleanPrice: 81.08, currentYield: 4.32 },
        { name: "Treasury 4.25% 2032", couponRate: 4.25, maturityDate: "2032-06-07", cleanPrice: 99.42, currentYield: 4.35 },
        { name: "Treasury 3.25% 2033", couponRate: 3.25, maturityDate: "2033-01-31", cleanPrice: 91.85, currentYield: 4.52 },
        { name: "Treasury 4.625% 2034", couponRate: 4.625, maturityDate: "2034-01-31", cleanPrice: 99.95, currentYield: 4.64 },
        { name: "Treasury 4.25% 2034", couponRate: 4.25, maturityDate: "2034-07-31", cleanPrice: 96.75, currentYield: 4.7 },
        { name: "Treasury 4.5% 2034", couponRate: 4.5, maturityDate: "2034-09-07", cleanPrice: 98.85, currentYield: 4.68 },
        { name: "Treasury 4.5% 2035", couponRate: 4.5, maturityDate: "2035-03-07", cleanPrice: 98.05, currentYield: 4.78 },
        { name: "Treasury 0.625% 2035", couponRate: 0.625, maturityDate: "2035-07-31", cleanPrice: 67.25, currentYield: 4.78 },
        { name: "Treasury 4.25% 2036", couponRate: 4.25, maturityDate: "2036-03-07", cleanPrice: 94.95, currentYield: 4.89 },
        { name: "Treasury 1.75% 2037", couponRate: 1.75, maturityDate: "2037-09-07", cleanPrice: 70.85, currentYield: 4.98 },
        // Long Term (15+ years) - Updated for July 22, 2025 market conditions
        { name: "Treasury 3.75% 2038", couponRate: 3.75, maturityDate: "2038-01-29", cleanPrice: 87.85, currentYield: 5.08 },
        { name: "Treasury 4.75% 2038", couponRate: 4.75, maturityDate: "2038-12-07", cleanPrice: 96.45, currentYield: 5.15 },
        { name: "Treasury 1.125% 2039", couponRate: 1.125, maturityDate: "2039-01-31", cleanPrice: 61.25, currentYield: 5.12 },
        { name: "Treasury 4.25% 2039", couponRate: 4.25, maturityDate: "2039-09-07", cleanPrice: 90.15, currentYield: 5.28 },
        { name: "Green Gilt 0.875% 2033", couponRate: 0.875, maturityDate: "2033-07-31", cleanPrice: 75.25, currentYield: 4.58 }
      ];
